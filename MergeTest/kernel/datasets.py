...
sys.path.append('%s/' % os.path.dirname(os.path.realpath(__file__)))
from kernel.utils import create_subgraphs, return_prob
...
#         data_list = [...]
        ...
        with open("/Users/yuxuanli/Desktop/circuit_design/pytorch-stable-diffusion-main/MergeTest/data/"+self.name+"_GC.pkl",'rb') as f:
            data = pickle.load(f)
            f.close()
        # with open('Users/yuxuanli/Desktop/circuit_design/pytorch-stable-diffusion-main/MergeTest/data/'+self.name+'_label_mapping.pkl', 'rb') as f:
        with open('/Users/yuxuanli/Desktop/circuit_design/pytorch-stable-diffusion-main/MergeTest/data/ltspice_examples_label_mapping.pkl', 'rb') as f:
